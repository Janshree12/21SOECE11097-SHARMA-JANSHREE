                    ...
                    <Card style={{ width:'1100px', backgroundColor: '#EBF8FC', height: '500px' }}>
                        ...
                        <ul style={{ listStyleType: 'none', padding: '0', margin: '0' }}>
                             <li style={{ display: 'inline-block', marginRight: '10px', marginLeft: '30px' }}>
                                <Link to='/admin' className="card-link" style={{ color: '#286575', fontWeight: 'bolder' }}>Group</Link>
                            </li>
                         <li style={{ display: 'inline-block', marginRight: '10px' }}>
                            <Link to='/teacherlist' className="card-link" style={{ textDecoration: 'none', color: '#286575', fontWeight: 'bolder' }}>Users</Link>
                        </li>
                        ...
                        <Card style={{ width: '1000px', marginLeft: '5px', marginTop: '30px', height: '360px', backgroundColor: '#FFFFFF' }}>
                            
                            <Link to='/creategroup' className="btn" style={{margin:'10px', border: 'none', borderRadius: '14px', color: '#ffffff', width: '120px', fontSize: 'larger', fontWeight: '650', backgroundColor: '#286575' }}>Create</Link>
