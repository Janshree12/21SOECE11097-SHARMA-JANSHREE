...
const UserCreate=()=>{
    ...
    function handleSubmit(event){
        ...
        axios.post('http://localhost:5001/api/teacher',{name,username,password})
        .then(res=>{
            console.log(res);
    ...
    {/* <Container bg='white' style={{marginLeft:'350px'}}>
        <Row>
            ...
            <br/><br/>
                ...
                <h3 style={{color: '#286575',}}><b>Teacher</b> </h3>
                ...
                <Form  class="fa fa-align-left"style={{color:'#286575'}}>
                                ...
                                <Form.Group >
                                    ...
                                    <Form.Control type="pass"style={{width: '100%',height:'33px',padding: '8px',border:'1px solid #286575',borderRadius: '4px',boxSizing: 'border-box'}} />
                                </Form.Group>
                                ...
                                <br/>
                                <br/>
                                <p><u><Link to='/teacherlist' style={{ textDecoration: 'none', color: '#286575',}}>Back To List</Link> </u></p>
                                </center>
                            </Form>
                            </Card.Body>
